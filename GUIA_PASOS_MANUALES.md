...
1. **SQL Editor:** ejecuta en orden `001_initial.sql`, `002_auth_rls.sql`, `003_options_levels_profiles.sql`; si aplica, `004_backfill_option_ids_from_text.sql` **antes** de `005`; luego `005_multi_gasto_bebida_emojis.sql` y `006_optional_gasto_remove_nada_dedupe_bebida.sql` (gasto opcional, quita “Nada”, dedupe bebidas).
