...
Orden: `001` → `002` → `003` → opcional `004` (antes de `005` si lo usas) → `005` → `006` → `007_sin_cafe_y_cacahuetes_collaret.sql` (“Sin café”, plural cacahuetes collaret). Ejecuta en el SQL Editor de Supabase o con la CLI.
